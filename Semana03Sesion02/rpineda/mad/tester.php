...
echo '</SELECT>'?>
		<br> <input class="btn btn-block btn-primary" type="submit"
				name="but_consultar" id="but_consultar" value="Consultar"
				onclick="consultar()" />		
		</div>
	...
	<div style="margin: 0px 2%; vertical-align: top;">
		...
		<h3>Funciones GET</h3>
		<table width="85%"
			class="table table-striped table-bordered table-condensed" border="1">
			<tr>
...
<script type="text/javascript">
				...
				var url = window.location.origin+"/DesarrolloPHPJunio2022/Semana03Sesion02/rpineda/mad/";
				function consultar()
				{
